...
The goal of adbcsqlite3 is to wrap the [ADBC](https://github.com/apache/arrow-adbc) [sqlite driver](https://github.com/apache/arrow-adbc/tree/main/c/driver/sqlite).

## Installation

You can install the development version of adbcsqlite3 from [GitHub](https://github.com/) with:
